...
/*   Updated: 2025/05/21 15:36:50 by llemmel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief	Check if the next character is a number
 * 
...
/**
 * @brief	Skip the white spaces in the string
 * 
 * @param	buf The string to check
 * @param	i The index of the string
 */
 ...
 * @return	false if the vector is not in the range
 */
